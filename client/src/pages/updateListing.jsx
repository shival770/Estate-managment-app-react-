  ...
  console.log(formData.imageURL);
    ...
    const handleUploadImage = (e) => {
        ...
        if (files.length > 0 && files.length < 7){
            ...
            setFilesUploadError("You can only upload 6 images per listings.");
            setUploading(false);
        }
    }
    ...
    <main className='max-w-4xl p-3 mx-auto'>
        ...
        <div className='flex flex-wrap gap-6 p-3'>
            <div className='flex gap-2  items-center'>
                <input onChange={handleOnChange}  min='1'max='10' className= 'border border-gray-500 rounded-lg p-3 ' id='bedrooms' type='number' value={formData.bedrooms} />
                <span>Beds</span>
            </div>
            <div className='flex gap-2 items-center '>
                <input onChange={handleOnChange} min='1'max='10' className='border border-gray-500 rounded-lg p-3 ' id='bathrooms' type='number' value={formData.bathrooms} />
                <span>Baths</span>
            </div>
        ...
        <div className='flex flex-col items-center gap-2 '>
            ...
            <button  className='bg-slate-800 m-3 text-white p-3 w-full border uppercase rounded-lg hover:opacity-95 disabled:opacity-85'>update</button>
        </div>
        </form>
